...
namespace FinanceOS.UI
{
    ...
    public sealed class SettingsController
    {
        ...
        public SettingsController(
            ...
            Action<AppTheme>? onThemeChanged = null, Action? onShowChangelog = null)
        {
            _settings = settings;
            _accounts = accounts;
            _backup = backup;
            ...
            _changelogButton = root.Q<Button>("changelog-button");
            _changelogButton.clicked += () => onShowChangelog?.Invoke();
