...
namespace FinanceOS.UI
{
    ...
    public sealed record OnboardingAccountRowViewModel(string Name, string TypeText, string BalanceText);

    /// <summary>One recurring operation already added during this onboarding session — see
    /// docs/07-Interface.md §4 (étape 3).</summary>
    public sealed record OnboardingOperationRowViewModel(string Name, string TypeText, string AmountText);
