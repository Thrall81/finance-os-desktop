...
| ADR-145 | DatePicker Unity App UI (com.unity.dt.app-ui) confirmé fonctionnel, généralisé à tous les champs date pertinents (Opérations récurrentes, Comptes, Prévisions ×3, Transactions) ; `DateField` du paquet évalué et écarté | ACCEPTED |
